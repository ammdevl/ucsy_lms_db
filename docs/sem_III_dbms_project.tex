...
\newcommand{\tabrowheight}{\vrule height 18pt depth 6pt width 0pt}


\newcolumntype{Y}{>{\tabrowheight}X}
\newcolumntype{L}{>{\tabrowheight}l}
...
\begin{titlepage}
    ...
    {\LARGE \textbf{UCSY Learning Management System}} \\[0.5cm]
    {\large Supervised by Daw Aye Nyein San} \\[1.8cm]
    ...
    {\large Group No - 3 (Section - B)} \\[0.3cm]
    {\large March, 2026}
    \vspace*{\vfill} 
\end{titlepage}
\newpage
...
\end{itemize}
\paragraph{}
\indent By integrating modern technology, this system reduces the administrative burdens, eliminates delays and enhances the efficiency of university learning management.
\newline
\newpage
\section{Project Objectives}
\paragraph{}
\indent The main goal of this project is to create a simple, reliable, and helpful Learning Management System for the university. The specific objectives are:
\begin{enumerate}
...
\paragraph{}
\indent To get a copy of our project, you can do the following steps:
\begin{enumerate}
...
% Chapter 2
\chapter{Database Design and Query Execution}
\section{Entity Relationship (ER) Diagram Drawn in StarUML}
\begin{figure}[h]
    \centering
...
\section{Entity Relationship (ER) Diagram Generated in MySQL Workbench}
\vspace{5cm}
\begin{figure}[h]
    \centering
...
\begingroup
\small
\begin{xltabular}{\textwidth}{|L|L|L|Y|L|L|L|}
    \hline
    ...
    Sections & section\_id & int & Unique ID for section & No & PK & \\ \hline
     & term\_id & int & Reference to Terms & No & FK & Terms \\ \hline
    ...
    Students & ykpt & int & Unique Student ID & No & PK & \\ \hline
     & section\_id & int & Reference to Sections & No & FK & Sections \\ \hline
     ...
     & edu\_mail & varchar(255) & UCSY email & No & & \\ \hline
    ...
    Parents & parent\_id & int & Unique ID for parent & No & PK & \\ \hline
     & ykpt & int & Reference to Students & No & FK & Students \\ \hline
    ...
    Instructors & instructor\_id & int & Unique ID for instructor & No & PK & \\ \hline
     ...
     & middle\_name & varchar(255) & Middle name & Yes & & \\ \hline
     & last\_name & varchar(255) & Last name & No & & \\ \hline
     & department\_id & int & Reference to Departments & No & FK & Departments \\ \hline
     & edu\_mail & varchar(255) & UCSY email & No & & \\ \hline
    ...
    Courses & course\_id & int & Unique ID for course & No & PK & \\ \hline
    	 & term\_id & int & Reference to Terms & No & FK & Terms \\ \hline
     & department\_id & int & Owning Departments & No & FK & Departments \\ \hline
    ...
    Lectures & lecture\_id & int & Unique ID for lecture & No & PK & \\ \hline
     & term\_id & int & Reference to Terms & No & FK & Terms \\ \hline
     & course\_id & int & Reference to Courses & No & FK & Courses \\ \hline
    ...
    Classes & class\_id & int & Unique ID for class instance & No & PK & \\ \hline
     & lecture\_id & int & Reference to Lectures & No & FK & Lectures \\ \hline
     & room\_id & int & Reference to Rooms & No & FK & Room \\ \hline
    ...
    Enrollments & enrollment\_id & int & Unique ID for enrollment & No & PK & \\ \hline
     ...
     & completion\_status & enum & NotStarted/ Progress/ Done & No & & \\ \hline

    % Announcements
    Announcements & announcement\_id & int & Unique ID for post & No & PK & \\ \hline
     & course\_id & int & Reference to Courses & No & FK & Courses \\ \hline
     & instructor\_id & int & Reference to Instructors & No & FK & Instructors \\ \hline
    ...
    Attendance & attendance\_id & int & Unique ID for attendance & No & PK & \\ \hline
     ...
     & time\_left & timestamp & Departure timestamp & Yes & & \\ \hline
    ...
    Assessments & assessment\_id & int & Unique ID for assessment & No & PK & \\ \hline
     ...
     & assessment\_type & enum & Tutorial/ Quiz /Lab Test/ etc. & No & & \\ \hline
     & assessment\_name & varchar(255) & Name of assessment & No & & \\ \hline
     & assessment\_description & text & Details of assessment & Yes && \\ \hline
     & due\_date & datetime & Deadline & No & & \\ \hline
     & assessment\_score & int & Max possible points & No & & \\ \hline
     & completion\_status & enum & NotStarted/ Progress/ Completed & No & & \\ \hline
...
\section{Data Insertion in Relational Tables}
\vspace{1cm}
\begin{figure}[h]
    \centering
...
\item What is the total number of resources available for a specific course (e.g., 'CS-101')?
\end{enumerate}
\newline
\section{Query Planning with Algebra}
...
\item  Check how many courses are currently "In Progress" for a specific semester (e.g., 'I')?
...
\item What is the total number of resources available for 'CS-101'?

$$\Pi_{\text{course\_name, total\_Resources}}$$
$$(\sigma_{\text{course\_name = 'IS-103'}}) (\gamma_{\text{course\_name; SUM(1)} \to \text{Total\_Resources}}(\text{Courses} \bowtie \text{Resources}))$$

\end{enumerate}
\newpage

\section{Query Execution with MySQL}
...
2. Check how many courses are currently "In Progress" for a specific semester (e.g., 'I')?
\begin{figure}[h]
    \centering
...
6. How can I retrieve the enrollment history of a specific student (e.g., Student ID 23023)?
\begin{figure}[h]
    \centering
...
\paragraph{• Relational Database Design (ERD | Normal Forms)}

\begin{verbatim}
	https://www.relationaldbdesign.com/index.php
\end{verbatim}
